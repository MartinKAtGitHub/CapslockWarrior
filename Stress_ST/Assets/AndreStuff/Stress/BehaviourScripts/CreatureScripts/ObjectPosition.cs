...
public class ObjectPosition : AbsoluteRoot {
	...
	protected List<RoomConnectorCreating> NeighbourGroups = new List<RoomConnectorCreating>();//all objects that are moving need to know in which room they are
